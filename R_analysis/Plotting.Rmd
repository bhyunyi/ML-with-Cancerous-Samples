...
```
We can see that the trend observed earlier: lower expression in cancer samples compared to normal samples—remains evident. This pattern appears to be even more pronounced when focusing specifically on the transcription factor genes.
